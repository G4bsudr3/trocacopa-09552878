    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-[11px] text-muted-foreground truncate">
          {s.kind === "crest" ? "Brasão" : s.kind === "team" ? "Time" : s.kind === "special" ? "Especial" : s.kind === "history" ? "FIFA WC History" : s.kind === "cover" ? "Capa" : s.kind === "player" ? (s.player_name || `Jogador #${s.position}`) : `Grupo ${s.group_letter ?? "?"}`}
        </p>
      </div>
